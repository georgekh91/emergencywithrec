...
import androidx.Contact.Worker;
import androidx.Contact.WorkerParameters;
...
public class senddata  extends Contact {
    
    private static final String TAG = SendDataContact.class.getSimpleName();
    private String str_number, str_contact_name, str_call_type, str_call_full_date,
            str_call_date, str_call_time, str_call_duration;

    public SendDataContact(@NonNull Context context, @NonNull Contact CONTACTParams) {
        super(context, CONTACTParams);
    }
    @NonNull
    @Override
